    ...
    def _extract_field_value(self, field_name: str, text: str) -> tuple:
        ...
        field_patterns = {
            ...
            'project_title': [
                ...
                r'Project\s+([A-Z][A-Za-z0-9\s&]+(?:Initiative|Project|Programme|Program|Foundation|Trust|Scholarship))',
                r'([A-Z][A-Za-z0-9\s&]+(?:Scholarship|Digital Learning|Education|Initiative|Project|Programme))',
            ],
            'implementing_agency': [
                r'implementing\s+(?:agency|organization|partner|ngo)\s*[:\-=]?\s*([^\n\r]+)',
                r'implementation\s+partner\s*[:\-=]?\s*([^\n\r]+)',
                r'agency\s+name\s*[:\-=]?\s*([^\n\r]+)',
                r'executed\s+by\s*[:\-=]?\s*([^\n\r]+)',
                r'([A-Z][A-Za-z0-9\s&]+(?:Trust|Foundation|Society|NGO|Association))',
            ],
            ...
            'contact_person': [
                ...
                r'Head\s+of\s+CSR\s*[—:\-=]?\s*([^\n\r]+)',
                r'Chairperson[,\s]+CSR\s+Committee\s*[—:\-=]?\s*([^\n\r]+)',
            ],
            'submission_date': [
            ...
            'unspent_amount': [
                ...
                r'balance\s*[:\-=]?\s*(?:INR|Rs\.?|₹|■)?\s*([\d,]+(?:\.\d{1,2})?)',
            ],
            'budget_categories': [
