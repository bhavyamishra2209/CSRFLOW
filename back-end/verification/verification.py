...
def verify_general_document(
    ...
    if found_refs:
        ...
        return {
            "status": "verified",
            "confidence": 0.95,
            "reason": f"Verified: Reference number {ref_name}='{ref_val}' verified against registry",
        ...
        return {
            "status": "verified",
            "confidence": 0.85,
            "reason": f"Verified: {len(extracted_fields)} document fields validated against registry structure",
            "matched_record": {"extracted_field_count": len(extracted_fields)},
            "missing_fields": [],
        }
    else:
        return {
            "status": "needs_review",
            "confidence": 0.50,
            "reason": "Needs Review: Document is pending field extraction and reference validation",
            "matched_record": None,
            "missing_fields": [],
        }
