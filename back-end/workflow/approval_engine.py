...
STAGE_REQUIRED_ROLES: Dict[ApprovalStage, List[str]] = {
    ...
    ApprovalStage.SUBMITTED: ["DOCUMENT_VERIFIER", "CSR_OFFICER", "ADMIN", "authenticated", "service_role"],
    ApprovalStage.DOCUMENT_VERIFICATION: ["DOCUMENT_VERIFIER", "CSR_OFFICER", "ADMIN", "authenticated", "service_role"],
    ApprovalStage.CSR_COMMITTEE_REVIEW: ["CSR_COMMITTEE_MEMBER", "BOARD_MEMBER", "ADMIN", "authenticated", "service_role"],
    ApprovalStage.FINANCIAL_AUDIT: ["FINANCIAL_AUDITOR", "FINANCE_LEAD", "ADMIN", "authenticated", "service_role"],
